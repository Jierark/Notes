...
DNS also supports the mapping of IP addresses to hostnames. This is coined as a reverse lookup, and its top level domain is inaddr.arpa.
...
- TCP issues.
Many of these can be mitigated using CDNs. While they have some cost in building them, the improvements to QoE are often way larger and make it worth the investment.